package com.rsa.execution.config.impl;
...
import com.rsa.execution.ProCExecutorCommonsExec;
...
public class ConfigurationManagerPropertiesImpl implements ConfigurationManager {
	...
	/* (non-Javadoc)
	 * @see com.rsa.execution.config.ConfigurationManager#getProgramConfiguration(java.lang.String)
	 */
